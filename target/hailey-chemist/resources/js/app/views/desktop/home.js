...
//						var parentIndex = (productCountByCategory.path.length-1);
...
//			********************************************************************************************************            
			...
			var paginationModel = {"pageNo":0, "pageSize":12};
...
//			});
			...
			var catModel={};
			self.strUrl=config.baseUrl + "rest/product-search/-1/pathCount";
//			bellow line make error when deploy on EC2, why?????
			//			self.strUrl="http://localhost:8080/hailey-chemist/rest/product-search/-1/pathCount";
